...
%token OP_ADD OP_SUB OP_MUL OP_DIV OP_REM OP_SHIFTLEFT OP_SHIFTRIGHT
%token OP_BINARYAND OP_BINARYOR OP_BINARYNOT OP_BINARYXOR
%token OP_ADD_IMM OP_SUB_IMM OP_MUL_IMM OP_DIV_IMM OP_REM_IMM OP_SHIFTLEFT_IMM OP_SHIFTRIGHT_IMM
%token OP_INCR OP_DECR OP_HALVE OP_DOUBLE OP_SQUARE OP_CUBE
%token OP_MOVE OP_SWAP OP_SET OP_LOAD OP_MERGE OP_STORE OP_POP OP_PUSH
%token OP_BRANCH OP_CALL OP_BRANCH_INDIRECT OP_CALL_INDIRECT OP_BRANCH_CONDITIONAL OP_BRANCH_UNCONDITIONAL_INDIRECT
%token OP_BRANCH_IF_THEN_ELSE OP_CALL_IF_THEN_ELSE
%token OP_COMPARE 
%token OP_SYSTEM
...
compare_op:
          ...
          ;
misc_op:
       OP_SYSTEM IMMEDIATE REGISTER REGISTER 
       { 
