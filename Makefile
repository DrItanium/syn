...
REPL_SERVER_BINARY = syn_server

REPL_SERVER_FINAL_OBJECTS = ReplSocketServer.o \
							${COMMON_THINGS} \
							${ARCH_OBJECTS} \
							${MAYA_OBJECTS} 
...
${REPL_SERVER_BINARY}: ${REPL_SERVER_FINAL_OBJECTS}
	@echo Building ${REPL_SERVER_FINAL_BINARY}
	@${CXX} ${LDFLAGS} -o ${REPL_SERVER_FINAL_BINARY} ${REPL_SERVER_FINAL_OBJECTS}
